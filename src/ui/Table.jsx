...
// use compound component pattern to implement a reusable table

// 1. create a context
const TableContext = createContext();

// 2. craete a parent component
...
// 4. add child components to the parent component as properties
Table.Header = Header;
Table.Body = Body;
Table.Row = Row;
Table.Footer = Footer;
